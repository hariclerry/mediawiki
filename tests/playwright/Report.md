...
* [Sample Playwright Page screenshot code](#sample-playwright-page-screenshot-code)
* [Playwright and Jest](#playwright-and-jest)
  * [Example of jest-playwright.config.js](#example-of-jest-playwright-config-js)
* [Playwright and WebdriverIO metrics](#playwright-and-webdriverIO-metrics)
  * [Statistics on WebdriverIO and Playwright Popularity](#statistics-on-webdriverIO-and-playwright-popularity)
  * [WebdriverIO and Playwright Mediawiki Core Tests Analysis](#webdriverIO-and-playwright-mediawiki-core-tests-analysis)
* [Why adapt Playwright](#why-adapt-playwright)
* [Advantages and disadvantages of Migrating from WebdriverIO](#advantages-and-disadvantages-of-migrating-from-webdriverI)
